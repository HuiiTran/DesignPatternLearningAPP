...
import Iterator from '../images/Iterator/iterator-en.png';
import Problem1 from '../images/Iterator/problem1.png';
import Problem2 from '../images/Iterator/problem2.png';
import Solution1 from '../images/Iterator/solution1.png';
import RealWorldAnalogy from '../images/Iterator/iterator-comic-1-en.png'
import Structure from '../images/Iterator/structure.png';

export const Iterator_En = {
    Intent: [
    ...
    Structure:[
        ...
        '4. The Collection interface declares one or multiple methods for getting iterators compatible with the collection. Note that the return type of the methods must be declared as the iterator interface so that the concrete collections can return various kinds of iterators.',
