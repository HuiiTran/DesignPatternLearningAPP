...
const AbstractFactoryScreen = ({navigation, route}) => {
    ...
    const FactoryMethod_En_Screen = AbstractFactory_En;
    return (
        <ScrollView showsVerticalScrollIndicator={false} style={styles.mainContainer}>
            ...
            {num_content_text(FactoryMethod_En_Screen.Problem[1])}
            {num_content_text(FactoryMethod_En_Screen.Problem[2])}
            ...
            {content_text(FactoryMethod_En_Screen.Problem[4])}
            ...
            {bug_content_text(FactoryMethod_En_Screen.Applicability[2])}
            {lightN_content_text(FactoryMethod_En_Screen.Applicability[3])}
            ...
            {greenTick_content_text(FactoryMethod_En_Screen.Pros[3])}
